...
Dilate {{ x+0.25, y+0.25, z+0.25},{1,4,4}} {Volume{2}; } 
Sphere(3) = {x+0.25, y+0.75, z+0.25, 0.05}; 
Dilate {{ x+0.25, y+0.75, z+0.25},{1,4,4}} {Volume{3}; } 
Sphere(4) = {x+0.75, y+0.25, z+0.25, 0.05}; 
Dilate {{ x+0.75, y+0.25, z+0.25},{1,4,4}} {Volume{4}; } 
Sphere(5) = {x+0.75, y+0.75, z+0.25, 0.05}; 
Dilate {{ x+0.75, y+0.75, z+0.25},{1,4,4}} {Volume{5}; } 
Sphere(6) = {x+0.25, y+0.25, z+0.75, 0.05}; 
Dilate {{ x+0.25, y+0.25, z+0.75},{1,4,4}} {Volume{6}; } 
Sphere(7) = {x+0.25, y+0.75, z+0.75, 0.05}; 
Dilate {{ x+0.25, y+0.75, z+0.75},{1,4,4}} {Volume{7}; } 
Sphere(8) = {x+0.75, y+0.25, z+0.75, 0.05}; 
Dilate {{ x+0.75, y+0.25, z+0.75},{1,4,4}} {Volume{8}; } 
Sphere(9) = {x+0.75, y+0.75, z+0.75, 0.05}; 
Dilate {{ x+0.75, y+0.75, z+0.75},{1,4,4}} {Volume{9}; } 
