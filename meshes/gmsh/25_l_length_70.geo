...
Box(1) = {0, 0, 0, 1, 1, 1};
x = 0; y = 0; z = 0; 
Box(2) = {x+0.07500000000000001, y, z, 0.05, 1, 1 }; 
Box(3) = {x+0.27499999999999997, y, z, 0.05, 1, 1 }; 
Box(4) = {x+0.475, y, z, 0.05, 1, 1 }; 
Box(5) = {x+0.6749999999999999, y, z, 0.05, 1, 1 }; 
Box(6) = {x+0.875, y, z, 0.05, 1, 1 }; 
...
Mesh.CharacteristicLengthMin = 0.70; 
Mesh.CharacteristicLengthMax = 0.70; 
