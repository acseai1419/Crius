...
//-----------------------------------------------------------------------------------------------------------------------
Sphere(2) = {x+0.1, y+0.5, z+0.5, 0.04}; 
Dilate {{ x+0.1, y+0.5, z+0.5},{1,10,10}} {Volume{2}; } 
Sphere(3) = {x+0.3, y+0.5, z+0.5, 0.04}; 
Dilate {{ x+0.3, y+0.5, z+0.5},{1,10,10}} {Volume{3}; } 
Sphere(4) = {x+0.5, y+0.5, z+0.5, 0.04}; 
Dilate {{ x+0.5, y+0.5, z+0.5},{1,10,10}} {Volume{4}; } 
Sphere(5) = {x+0.7, y+0.5, z+0.5, 0.04}; 
Dilate {{ x+0.7, y+0.5, z+0.5},{1,10,10}} {Volume{5}; } 
Sphere(6) = {x+0.9, y+0.5, z+0.5, 0.04}; 
Dilate {{ x+0.9, y+0.5, z+0.5},{1,10,10}} {Volume{6}; } 
